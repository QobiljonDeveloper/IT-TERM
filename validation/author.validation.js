...
exports.authorValidation = (body) => {
  const schema = Joi.object({
    ...
    nick_name: Joi.string().min(3).max(15).messages({
      "string.min": "Nick kamida 3 ta belgidan iborat bo'lishi kerak",
      "string.max": "Nick juda uzun — maksimal 15 ta belgi",
    }),
    ...
    gender: Joi.string().lowercase().valid("erkak", "ayol"),
